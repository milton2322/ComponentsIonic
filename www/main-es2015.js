...
let FiltroPipe = class FiltroPipe {
    ...
    transform(arreglo, text, columna) {
        if (text === '') {
            return arreglo;
        }
...
module.exports = __webpack_require__(/*! C:\Users\Administrador\Documents\proyecto_ionic\components\src\main.ts */"./src/main.ts");
